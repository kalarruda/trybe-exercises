...
if __name__ == "__main__":
    ...
    print(linked_list)
    # saída: LinkedList(len=2
    # value=Node(value=1 next=Node(value=5 next=None)))
...
# PRECISA RODAR NO TERMINAL PARA APARECER OS NÓS


variavel1 = LinkedList()

variavel1.insert_at(2)
