class Stack():
    ...
    def is_empty(self):
        ...
        # pega o valor de bool se o self.size é zero fica False
    ...
    def pop(self):
        ...
        value = self._data[-1]
        del self._data[-1]
        # deleta o ultimo elemento do topo da pilha
        return value
    ...
    def peek(self):
        if self.is_empty():
            return None
        value = self._data[-1]
        # ver o ultimo elemento do topo da pilha
        return value

    def clear(self):
        self._data.clear()
    # limpar todos elementos da pilha
